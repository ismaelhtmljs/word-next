        ...
        <div className='bg-gray-200 p-[35px]' id='contact' translate="no">
            <div className='flex flex-col justify-center items-center gap-3'>
                <div className='flex flex-col gap-4 text-center'>
                    ...
                    {/*  */}
                    <div className='flex flex-wrap gap-5 reponsive-flex justify-center'>
                        <div className='items-center flex gap-2 justify-center'>
                            <FaPhone className='text-color' />
                            <a href="https://wa.me/51978680283" className='text-color hover:underline text-size-responsive-footer'>+51 978-680-283 (Ismael Guerrero)</a>
                        </div>
                        <div className='items-center flex gap-2 justify-center'>
                            <CgMail className='text-color' />
                            <a href="mailto:ismaelgq.88@gmail.com" className='text-color hover:underline text-size-responsive-footer'>ismaelgq.88@gmail.com</a>
                        </div>
                        <div className='items-center flex gap-2 justify-center'>
                        ...
                        <div className='items-center flex gap-2 justify-center'>
                            <FaPhone className='text-color' />
                            <a href="https://wa.me/51930848164" className='text-color hover:underline text-size-responsive-footer'>+51 930-848-164 (Matias Jibaja)</a>
                        </div>
                        <div className='items-center flex gap-2 justify-center'>
                            <FaInstagram className='text-color' />
